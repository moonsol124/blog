...
function CommentForm(props) {
    ...
    function handleSubmit(e) {
        ...
        const url = `http://localhost:5000/blog/post/${location.state.postid}/comment/${location.state.commentid}/update_comment`;
        console.log (url);
        ...
        <div className="post-detail-container comment-form-container">
            ...
            <form onSubmit={handleSubmit} className="comment-form">
                ...
                <div className="comment-form-input-container">
                    ...
                    <textarea name='comment' id='comment' rows="10"className="form-input" defaultValue={location.state.content}/> 
                </div>
                <div className="comment-message-container">
                    <p className="warning-message">{message}</p>
                </div>      
                <div className="comment-btn-container">
                    <button type='submit' className="link-texts"> Update comment </button>
                </div>
            </form>
        </div>
    )
